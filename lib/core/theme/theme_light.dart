...
class ThemeLight {
  ...
  static ThemeData light = ThemeData(
    splashColor: _colors.accentColor,
  ...
  static DividerThemeData _dividerTheme() {
    return DividerThemeData(color: _colors.borderColor, indent: 0, endIndent: 0, thickness: 1);
  }
  ...
  static BottomNavigationBarThemeData _bottomNavigationBarTheme() {
    return BottomNavigationBarThemeData(
      selectedItemColor: _colors.text,
  ...
  static OutlinedButtonThemeData _outLinedButtonTheme() {
    return OutlinedButtonThemeData(
      style: OutlinedButton.styleFrom(
        ...
        disabledBackgroundColor: _colors.inactiveColor,
        elevation: 0,
  ...
  static InputDecorationTheme _inputDecorationTheme() {
    return InputDecorationTheme(
      ...
      labelStyle: TextStyle(color: Colors.grey, fontSize: 14, fontWeight: FontWeight.w600),
